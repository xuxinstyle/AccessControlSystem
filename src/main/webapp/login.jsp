...
<body>
	...
	<form name="formlogin" action="${pageContext.request.contextPath}/login"
		...
		<div
			...
			<div
				...
				<p style="margin: 0px 35px 20px 45px;">
					<span style="float: left;">基于人脸识别的门禁信息系统</span> 
					<span><font color="red" id="error">${msg }</font></span> 
					<span
						style="float: right;"> 
						
				 <input type="submit" 
						 style="background: rgb(0, 142, 173);
						  padding: 7px 10px; 
						 border-radius: 4px; 
