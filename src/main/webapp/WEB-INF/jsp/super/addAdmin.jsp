			...
			<div class="col-md-10">
				<div class="">
				    <div class="panel-heading">
						<div class="row">
					    	<h1 style="text-align: center;">添加管理员信息</h1>
						</div>
				    </div>
				    <div class="">
						<form class="form-horizontal" name="reset" action="${pageContext.request.contextPath}/super/addAdmin" id="editfrom" method="post" onsubmit="return check()">
