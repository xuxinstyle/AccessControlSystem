			...
			<div class="col-md-10">
				<div class="">
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" name="reset" role="form" action="${pageContext.request.contextPath}/super/userPasswordRest" id="editfrom" method="post" onsubmit="return check()">
