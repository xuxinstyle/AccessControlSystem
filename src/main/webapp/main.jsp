...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        ...
        <div title="管理员管理" data-options="iconCls:'icon-bkgl'" style="padding:10px;">
            <a href="javascript:openTab('添加管理员','writeBlog.jsp','icon-writeblog')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-writeblog'" style="width: 150px;">添加管理员</a>
            <a href="javascript:openTab('管理员信息管理','blogManage.jsp','icon-bkgl')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">管理员信息管理</a>
            <a href="javascript:openTab('用户信息查询','blogManage.jsp','icon-bkgl')" class="easyui-linkbutton"
        ...
        <div title="用户管理" data-options="iconCls:'icon-bkgl'" style="padding:10px;">
            <a href="javascript:openTab('添加用户','writeBlog.jsp','icon-writeblog')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-writeblog'" style="width: 150px;">添加用户</a>
            <a href="javascript:openTab('用户信息管理','blogManage.jsp','icon-bkgl')" class="easyui-linkbutton"
